...
export const ap = new Aprendiz("Juan Felipe", "Tamayo", "avatar.png", 30, NivelEducativo.POSGRADO, cursos);
...
btnFiltro.onclick = () => {
    ...
    mostrarCurosAprendiz(cursosFiltrados);
};

mostrarDatosAprendiz(ap);
mostrarEstadisticas(ap);
mostrarCurosAprendiz(ap.cursos);
...
function mostrarCurosAprendiz(cursos: Curso[]): void{ 
